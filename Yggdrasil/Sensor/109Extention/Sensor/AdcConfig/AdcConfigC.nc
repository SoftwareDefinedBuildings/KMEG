...
generic configuration AdcConfigC(uint8_t extChannel) {
...
implementation {
  ...
  components new AdcConfigP(extChannel);
  AdcReadClientC.AdcConfigure -> AdcConfigP;
  AdcReadStreamClientC.AdcConfigure -> AdcConfigP;

  components new AdcReadNowClientC();
  Resource = AdcReadNowClientC;
  ReadNow = AdcReadNowClientC;
  
  AdcReadNowClientC.AdcConfigure -> AdcConfigP;
}

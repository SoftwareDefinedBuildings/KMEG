...
implementation {
  ...
  components HplMsp430InterruptC, new Msp430InterruptC() as port21i;
  components HplMsp430GeneralIOC , new Msp430GpioC() as port21g;

  port21i.HplInterrupt -> HplMsp430InterruptC.Port21;
  port21g.HplGeneralIO -> HplMsp430GeneralIOC.Port21;
  PIRSensorP.GpioInterrupt -> port21i;
  PIRSensorP.GeneralIO -> port21g;
#else
  // For PIR Seosor Interrupt Wiring

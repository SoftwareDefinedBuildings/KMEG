...
//		memcpy(&mo[rev_cur], msg, len);
	...
	task void insertM(){
		...
		mango_mobile_oscilloscope_t *recvMessage;
		recvMessage = (mango_mobile_oscilloscope_t*)rev_payload[rev_cur];
		id = recvMessage->mobileId;
		rssi = rev_rssi[rev_cur];
		seq = recvMessage->seqno;
		rev_cur = rev_cur ^ 1;

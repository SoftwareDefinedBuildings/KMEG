...
// TH Seosor Wiring
	...
	*/
	...
	/*
	ThermoLoggerSensorP.Adc1 -> Adc;
	ThermoLoggerSensorP.Adc2 -> Adc;
	ThermoLoggerSensorP.Adc3 -> Adc;
	ThermoLoggerSensorP.Adc4 -> Adc;
	ThermoLoggerSensorP.Adc5 -> Adc;
	ThermoLoggerSensorP.Adc6 -> Adc;
	ThermoLoggerSensorP.Adc7 -> Adc;
	*/
	components BatteryC;
